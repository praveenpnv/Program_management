...
export default class Userpicklist extends LightningElement {
    ...
    @api context;
    @api variant;
    @api name; // This will be the field API name, e.g., 'Responsible_Recruiter__c'
    showPicklist = false;
    ...
    updateDisplayValue() {
        if (this.options && this.value) {
            ...
            this.displayValue = this.label; // Fallback to the label if no value or options
        }
    }
    ...
    handleChange(event) {
        ...
        this.updateDisplayValue(); // Update the display text to the selected user's name
